...
public class StockMessageRabbitConfigurationListener extends MessageRabbitConfigurationListener {
	...
	@Autowired
	public StockMessageRabbitConfigurationListener(@Value("${secinfo_external_queue}") String queueName, @Value("${secinfo_fanout_exchange}") String exchageName) {
